...
def dashboard():
    ...
    return render_template("dashboard.html", this_user = this_user, all_devices = device.Device.view_users_posted_devices(data), all_saved_devices = device.Device.view_users_saved_devices(data))
